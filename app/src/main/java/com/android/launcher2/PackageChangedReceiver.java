...
public class PackageChangedReceiver extends BroadcastReceiver {
	...
	public void onReceive(final Context context, Intent intent) {
		...
		if (!intent.getAction().equals("android.intent.action.PACKAGE_ADDED")) {
			...
			WidgetPreviewLoader.removeFromDb(app.getWidgetPreviewCacheDb(),
					packageName);
		...
		if (intent.getAction().equals("android.intent.action.PACKAGE_ADDED") ||
			...
			try {
				if (Utilities.mSystemUI != null) {
					...
					if (Utilities.mSystemUI.equals(MachineConfig.VALUE_SYSTEM_UI20_RM10_1)) {
					...
					} else if (Utilities.mSystemUI.equals(MachineConfig.VALUE_SYSTEM_UI21_RM10_2)) {
					...
					} else if (Utilities.mSystemUI.equals(MachineConfig.VALUE_SYSTEM_UI21_RM12)) {
					...
					if (fss != null && fss.pkgName != null && fss.screen != null
							&& fss.screen_x != null && fss.screen_y != null) {
