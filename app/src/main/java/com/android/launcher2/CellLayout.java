...
public class CellLayout extends ViewGroup {
    ...
    public CellLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mId = getId();
        if (mId==R.id.celllayout_screen2){
        	mCountX = 0;
        	mCountY = 0;
        }else{
...
//            if (mIsHotseat) {
//                bubbleChild.setTextColor(res.getColor(android.R.color.transparent)); //by allen
//            } else {
//                bubbleChild.setTextColor(res.getColor(R.color.workspace_icon_text_color));
//                bubbleChild.sets
//                bubbleChild.setBackgroundResource(R.drawable.app_bg_2);
//            }

//            child.setBackgroundResource(R.drawable.app_bg);
        }

//        Log.d(TAG, ""+child + "::::"+(child instanceof BubbleTextView));
