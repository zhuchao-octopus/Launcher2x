...
public class PagedViewIcon extends TextView {
	...
	public void applyFromApplicationInfo(ApplicationInfo info, boolean scaleUp,
		...
		if (MachineConfig.VALUE_SYSTEM_UI_KLD5.equals(Utilities.mSystemUI)) {
			setCompoundDrawablesWithIntrinsicBounds(new FastBitmapDrawable(
					mIcon), null, null, null);
//			int id = Utilities.getmagicBackgroundId(mIcon);
//			setBackground(getContext().getResources().getDrawable(id));
			int color = Utilities.getmagicBackgroundId(mIcon);
			...
			setCompoundDrawablesWithIntrinsicBounds(null,
					new FastBitmapDrawable(mIcon), null, null);
